...
* [#11387](https://dev.ckeditor.com/ticket/11387): Fixed: `roles="radiogroup"` should be applied only to radio inputs' container.
...
* [#10360](https://dev.ckeditor.com/ticket/10360): Fixed: ARIA `roles="application"` should not be used for dialog windows.
* [#10361](https://dev.ckeditor.com/ticket/10361): Fixed: ARIA `roles="application"` should not be used for floating panels.
