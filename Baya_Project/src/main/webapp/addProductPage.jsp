<%@ page import="com.baya.baya_project.Model.SubCategory" %>
<%@ page import="java.util.List" %>
<%@ page import="com.baya.baya_project.service.ProductAdminService" %>
<%@ page import="com.baya.baya_project.Model.Category" %>
<!DOCTYPE html>
<html>
...
<div class="wrapper">
    ...
    <div class="container addproduct-container">
        ...
        <div class="row main-addproduct mt-3">
            ...
            <form class="form-addproduct d-flex"  action="AddProduct"  method="POST" enctype="multipart/form-data" onsubmit="return checkForm()">
                        ...
                        <div class="wrap mt-3">
                            ...
                            <div class="dandev-reviews">
                                <div class="form__input form_upload">
                                    <label class="dandev_insert_attach  " style=" color: white; border-radius: 5px;background-color: #3bacf0; padding: 2px">Thêm hình ảnh liên quan</label>
                                </div>
                ...
                <div class="col-12 col-md-6 addproduct-form-right">
                    ...
                    <div class="mb-1">
                        ...
                        <input type="text" class="form-control input-size-addproduct color-input" id="product-name"
                               name="pname"   placeholder="Nhập tên sản phẩm" value="" >
                    </div>
                    <!-- Mã sản phẩm-->
                    <div class="mb-1">
                        <label  class="form-label ">Mã Sản Phẩm</label>
                        <input type="text" class="form-control input-size-addproduct color-input" id="product-code"
                               name="pcode"  placeholder="Nhập Mã Sản Phẩm" value="" >
                    </div>
                    ...
                    <div class="mb-1">
                        ...
                        <textarea type="text" class="form-control input-size-addproduct color-input" id="product-description" style="height: 200px;"
                                  name="pdescription"   placeholder="Nhập Mô Tả Sản Phẩm" ></textarea>
                    </div>
                    <!-- Tiêu chuẩn-->
                    <div class="mb-1">
                        ...
                        <input type="text" class="form-control input-size-addproduct color-input" id="product-standard"
                               name="ptieuchuan"  placeholder="Nhập Mô Tả Sản Phẩm" ></input>
                    </div>
                    ...
                    <div class="mb-1">
                        ...
                        <input type="text" class="form-control input-size-addproduct color-input" id="product-material"
                               name="pmaterial"  placeholder="Nhập chất liệu sản phẩm" >
                    </div>
                    <!-- Chất liệu -->
                    <div class="mb-1">
                        ...
                        <input type="text" class="form-control input-size-addproduct color-input" id="product-size"
                               name="psize" placeholder="Nhập kích thước sản phẩm" >
                    </div>
                    ...
                    <div class="mb-1">
                        ...
                        <input type="text" class="form-control input-size-addproduct color-input" id="product-origin"
                               name="porigin"  placeholder="Nhập xuất xứ sản phẩm" >
                    </div>

                    <!-- Số lượng -->
                    <div class="mb-1">
                        <label for="quantity" class="form-label">Số Lượng Trong Kho</label>
                        <input type="number" class="form-control input-size-addproduct color-input" id="product-quantity"
                    ...
                    <div class="mb-1">
                        ...
                        <input type="number" class="form-control input-size-addproduct color-input" id="product-price"
                               name="pprice"   placeholder="Nhập giá sản phẩm" >
                    </div>
                    <%--                              <!-- ngày tạo -->--%>
                    <%--                              <div class="mb-1 new-date-input">--%>
                    <%--                                <label for="createDate" class="form-label">Ngày Tạo</label>--%>
                    <%--                                <input type="date" class="form-control input-size-addproduct" name="pcreatedate" id="createDate" placeholder="Chọn ngày tạo">--%>
                    <%--                            </div>--%>

                    <button type="submit" class="btn btn-primary btn-light " style="color: white;" id="btn-addproduct">Thêm Sản Phẩm</button>
                </div>
            </form>
        </div>
