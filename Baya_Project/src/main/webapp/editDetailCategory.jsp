    ...
    <div class="wrapper">
        ...
        <div class="container addnew-container">
            ...
            <div class="row  main-addnew mt-3">
                <form action="/editDetailCategory" method="post" class="form-addnew d-flex" onsubmit="return checkAdd()">
                    ...
                    <div class="col-12 form_right " >
                        ...
                        <div class="mb-1">
                            ...
                            <input type="text"  class="form-control color-input size_textarea" value="${category.categoryID}" autocomplete="off"  id="id" name="id"
                                placeholder="Nhập ID" >
                        </div>
                        <div class="mb-1">
                            <label  class="form-label">Tên Danh Mục</label>
                            <input autocomplete="off"  type="text" class="form-control color-input size_textarea"
                                   placeholder="Nhập tên tiêu đề"  name="name" id="name" value="${category.name}">
                        </div>
