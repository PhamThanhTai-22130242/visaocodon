...
public class MailForgetPassword {
    ...
    public MailForgetPassword(String tokens, String email, int type) {
        content ="<!DOCTYPE html>\n" +
                ...
                "</body>\n" +
                "\n" +
                "</html> Nhấn vào đây: http://localhost:8080/activateForgetPassword?tokens="+tokens+ "&email="+email+ "&type="+ type+ "";
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println( new MailForgetPassword("aaa", "22130242@st.hcmuaf.edu.vb", 1).getContent());
    }
}
